// ============================================
//      JAVATEAM - ОСНОВНОЙ СКРИПТ v6.0
// ============================================

console.log('%c⚡ JAVATEAM SCRIPT v6.0', 'color: #7C3AED; font-size: 16px; font-weight: bold;');
        ...
        mainContainer.innerHTML = mainRoster.map(p => `
            <div class="player-card">
                ...
                <div class="player-stats">
                    ...
                    <div class="player-stat"><span class="stat-label">ПРАКИ</span><span class="stat-value">${p.matches}</span></div>
